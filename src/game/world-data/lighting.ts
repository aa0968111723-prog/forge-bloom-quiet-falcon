...
export const TIME_PRESETS: Record<TimeOfDay, LightingPreset> = {
  day: {
    label: "晴天",
    // Late-morning warmth rather than clinical noon: the golden cast over the
    // canopy is most of what makes the hill read like the postcard view.
    sun: "#ffedc8",
    sky: "#8ec3e0",
    fog: "#c9d6d8",
    hemiSky: "#cfe4ef",
    ...
    wetness: 0,
    lampsOn: false,
    disc: { position: [150, 230, 170], radius: 9, color: "#fff8e2" },
  },
  cloudy: {
    label: "淡水陰天",
    sun: "#dfe6ec",
